...
class Yundama():
    def __init__(self, username, password, app_id, app_key, api_url):
...
if __name__ == '__main__':
    ...
    ydm = Yundama(YUNDAMA_USERNAME, YUNDAMA_PASSWORD, YUNDAMA_APP_ID, YUNDAMA_APP_KEY, YUNDAMA_API_URL)
